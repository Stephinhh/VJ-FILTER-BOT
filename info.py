...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://wonderland2000azz:9dCcTHmEtyeqjclm@cluster0.26ldw0e.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")   # IF Multiple Database Is False Then Fill Only This Database Url.
DATABASE_NAME = environ.get('DATABASE_NAME', "njaan")
...
# Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/+wkQ-0AT1429lYjdl')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/+DShs-nlruJ42Nzc1')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/+oEgU5IpLNwozNmU9') # Support Chat Link Without https:// or @
