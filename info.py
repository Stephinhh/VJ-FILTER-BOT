...
auth_channel = environ.get('AUTH_CHANNEL', '-1002640297446') # give your force subscribe channel id here else leave it blank
...
PUBLIC_FILE_CHANNEL = environ.get('PUBLIC_FILE_CHANNEL', '0') # Public Channel Username Without @ or without https://t.me/ and Bot Is Admin With Full Right.


# Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/movie_zone3k')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/mz_movie_zone3k')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'mzsupportzz') # Support Chat Link Without https:// or @
